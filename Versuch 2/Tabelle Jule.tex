...
\fbox{
  \begin{minipage}[t][2cm][t]{6cm} 
   Werte:\\
   $\Delta \lambda = (680 \pm 170) \ \mathrm {nm} $\\
   $ d \quad = (72 \pm 8)$ \si\micro m\\
  \end{minipage}
}
\end{Large}
...
\end{figure}
\footnotetext{Skriptum für das Praktikum zur Einführung in die Physikalische Chemie, Institut für physikalische Chemie, Uni Göttingen, 2015, Seite 7}%Achtung: hier Phasengeschwindigkeit als c
...
\footnotetext{Skriptum für das Praktikum zur Einführung in die Physikalische Chemie, Institut für physikalische Chemie, Uni Göttingen, 2015, Seite 11}


\newpage

\subsection{Interferenz}
Überlagern sich zwei oder mehr Wellen, so führt dies zu einer Amplitudenänderung. Die Wellen verschmelzen zu einer neuen Welle mit größerer oder kleinerer Amplitude, je nachdem, ob gleiche oder unterschiedliche Phasen aufeinandertreffen. Diese Erscheinung wird Interferenz genannt. Treffen Maxima oder Minima aufeinander, so wird die Amplitude verstärkt (konstruktive Interferenz); trifft Maximum auf Minimum so löschen sich die Wellen gegenseitig aus (destruktive Interferenz). 
...
\caption{Auf den Schirm abgebildetes Beugungsbild \protect\footnotemark}
\end{figure}
\footnotetext{Skriptum für das Praktikum zur Einführung in die Physikalische Chemie, Institut für physikalische Chemie, Uni Göttingen, 2015, Seite 10}
...
\caption{Beugungswinkel $\beta_n$ im Verhältnis zu $z_0$ und $y_n$\protect\footnotemark}
\end{figure}
\footnotetext{Skriptum für das Praktikum zur Einführung in die Physikalische Chemie, Institut für physikalische Chemie, Uni Göttingen, 2015, Seite 11}
...
%an Alea: eigentlich nicht nach Gleichung 7, sondern erst wenn man sie umstellt:  $\sin\beta_n = \frac{n}{d}\cdot \lambda$ oder hast du das bewusst rausgenommen?
